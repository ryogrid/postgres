/*-------------------------------------------------------------------------
 *
 * cmd_out_util --- assistance functions for ecpg syntax error detecting
 *                  regression test
 * 
 ...
 *
 * src/interfaces/ecpg/test/cmd_out_util.c
 *
 *-------------------------------------------------------------------------
 */
...
int exec_ecpg(const char *first, ...) {
    va_list args;
    const char *args_array[5] = {0}; // To store arguments, including the NULL sentinel
    pid_t pid;
    int status;
